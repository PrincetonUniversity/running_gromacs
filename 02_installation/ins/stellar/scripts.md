...
$ wget https://raw.githubusercontent.com/PrincetonUniversity/running_gromacs/main/02_installation/ins/stellar/stellar_intel.sh
# make modifications to stellar_intel.sh if needed (e.g., choose a different version)
$ bash stellar_intel.sh | tee build.log
```
